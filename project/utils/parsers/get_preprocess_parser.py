...
def data_prepro_parser():
    ...
    parser.add_argument("--test_ratio. Specify the test ratio. Standard: 3000 samples. If you pass a float, this will be split the data based on that proportion, e.g. 0.1 --> 0.8, 0.1, 0.1",
