...
from settings import CORPORA_LINKS_TMX, CORPORA_LINKS_TXT
...
def maybe_download_and_extract_corpus_from_opus(corpus: Union[List, str] = "Europarl", language_code="de", tmx=False):
    """
    ...
    """
    for c in corpus:
        corpus_name = c.lower().strip()
        assert corpus_name in CORPORA_LINKS_TMX.keys() or corpus_name in CORPORA_LINKS_TXT.keys(), \
